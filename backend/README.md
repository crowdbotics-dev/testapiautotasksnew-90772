...
## Project Structure
    ...
    ├── testapiautotasksnew_90772  # Django project configurations
...
1. Clone this repo and `cd testapiautotasksnew_90772`
...
2. Clone this repo and `cd testapiautotasksnew_90772`
